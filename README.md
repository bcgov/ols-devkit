...
[Address List Editor](https://bcgov.github.io/ols-devkit/ale/)|Web app|Allows everyone to clean and geocode a list of up to 1,000 addresses|end users
...
[Address autocompletion demo app](https://bcgov.github.io/ols-devkit/examples/address_autocomplete.html)|Web app|Demonstrates how to integrate the geocoder's autocompletion capability into their own web apps; uses javascript and leaftlet|web app developers
