...
[Batch List Address Submitter](https://github.com/bcgov/ols-devkit/tree/gh-pages/als)|Web page containing Python script|Python Script submits an address list to the Batch Geocoder plugin running in the Concurrent Processing Framework and retrieves the results| Workflow automation developers|
